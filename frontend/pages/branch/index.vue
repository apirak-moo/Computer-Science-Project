  ...
  <div class="container mx-auto p-4 space-y-8">
    <Breadcrumb>
      <BreadcrumbList>
        ...
        <BreadcrumbItem>
          <BreadcrumbPage>แขนงวิชา</BreadcrumbPage>
        </BreadcrumbItem>

      </BreadcrumbList>
    </Breadcrumb>

    <h1 class="text-3xl my-5 font-bold text-sky-700 mb-6 text-center">แขนงวิชา</h1>
    ...
    <div v-if="branchs" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
      <NuxtLink v-for="branch in filteredBranchs" :key="branch.id" :to="`/branch/${branch.id}`"
        ...
        <NuxtImg :src="`${apiBase}/images/${branch.image}`" width="600" height="400" format="webp" quality="80"
          :alt="branch.nameTh" placeholder loading="lazy"
