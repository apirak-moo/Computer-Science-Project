                        ...
                        <div
                            ...
                            <dl class="space-y-4">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-3 gap-x-4 gap-y-1">
                                    ...
                                    <Select v-model="person.profile.title.id" class="sm:col-span-2 w-full">
                            ...
                            <dl class="space-y-4">
                                <div class="grid grid-cols-1 sm:grid-cols-3 gap-x-4 gap-y-1">
                                    ...
                                    <Input class="sm:col-span-2 text-sm text-gray-900 dark:text-white"
