...
const filterProgram = computed(() => {
    return programs.value?.filter(p => p.degree.id === major.value?.program.degree.id)
})
...
async function submitForm() {
    ...
    formData.append('programId', String(major.value?.program.id ?? ''))
                    ...
                    <Dialog>
                        ...
                        <DialogContent class="sm:max-w-[425px]">
                            <DialogHeader>
                                ...
                                <DialogDescription>
                                    คุณต้องเปลี่ยนแปลงข้อมูลสาขาวิชา {{ major?.nameTh }} หรือไม่
                                </DialogDescription>
                            </DialogHeader>
                    ...
                    <Dialog>
                        ...
                        <DialogContent class="sm:max-w-[425px]">
                            <DialogHeader>
                                ...
                                <DialogDescription>
                                    คุณต้องการลบสาขาวิชา {{ major?.nameTh }} หรือไม่
                                </DialogDescription>
                            </DialogHeader>
                            <DialogClose as-child>
                                <DialogFooter>
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <Select v-model:model-value="major.program.degree.id">
                                    <SelectTrigger>
                        ...
                        <li class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <Select v-model:model-value="major.program.id">
                                    <SelectTrigger>
                                        <SelectValue placeholder="Select a program" />
                                    </SelectTrigger>
                                    <SelectContent>
