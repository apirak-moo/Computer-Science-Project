...
const major = useRoute().params.id

const { data: professors } = await useAsyncData<PaginatedResponse<Professor>>('majorProfessor', () => {
...
<template>
    <div class="overflow-x-auto p-4">
        <h1 class="text-3xl font-bold text-sky-700 mb-10 text-center">อาจารย์ประจำสาขา{{ major.id }}</h1>
